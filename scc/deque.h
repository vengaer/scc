...
#define scc_deque_impl_base_qual(deque, qual)                                                      \
    scc_container_qual((unsigned char qual *)(deque) - scc_deque_impl_npad(deque),                 \
                       struct scc_deque_base, rd_buffer, qual)

#define scc_deque_impl_base(deque) scc_deque_impl_base_qual(deque, )
...
#define scc_deque_new(type)                                                                        \
    (type *)scc_deque_impl_new((void *)&(scc_deque_impl_layout(type)){0},                          \
                               scc_deque_impl_dataoff(type), SCC_DEQUE_STATIC_CAPACITY)

#define scc_deque_new_dyn(type)                                                                    \
    (type *)scc_deque_impl_new_dyn(sizeof(scc_deque_impl_layout(type)),                            \
                                   scc_deque_impl_dataoff(type), SCC_DEQUE_STATIC_CAPACITY)
...
#define scc_deque_push_front(dequeaddr, ...)                                                       \
    (scc_deque_impl_prepare_push(dequeaddr, sizeof(**(dequeaddr))) &&                              \
         ((*(dequeaddr))[scc_deque_impl_push_front_index(*(dequeaddr))] = __VA_ARGS__),            \
     1)
...
#define scc_deque_pop_back(deque) (deque)[scc_deque_impl_pop_back_index(deque)]
...
#define scc_deque_pop_front(deque) (deque)[scc_deque_impl_pop_front_index(deque)]
...
#define scc_deque_back(deque) (deque)[scc_deque_impl_back_index(deque)]

#define scc_deque_front(deque) (deque)[scc_deque_impl_base_qual(deque, const)->rd_begin]
...
#define scc_deque_clone(deque) scc_deque_impl_clone(deque, sizeof(*(deque)))
