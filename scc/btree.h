...
#define scc_btree_with_order(type, compare, order)                                                 \
    scc_btree_impl_with_order(                                                                     \
        &(scc_btree_impl_layout(type, order)){                                                     \
            .bt1 =                                                                                 \
                {                                                                                  \
                    .bt0 = {.bt_order = order,                                                     \
        ...
        scc_btree_impl_curroff(type), scc_btree_impl_rootoff(type, order))

#define scc_btree_new(type, compare)                                                               \
    (type *)scc_btree_impl_new(                                                                    \
        &(scc_btree_impl_layout(type, SCC_BTREE_DEFAULT_ORDER)){                                   \
            .bt1 =                                                                                 \
                {                                                                                  \
                    .bt0 = {.bt_order = SCC_BTREE_DEFAULT_ORDER,                                   \
                            .bt_dataoff = scc_btnode_impl_dataoff(type),                           \
        ...
        scc_btree_impl_curroff(type), scc_btree_impl_rootoff(type, SCC_BTREE_DEFAULT_ORDER))

#define scc_btree_with_order_dyn(type, compare, order)                                             \
    scc_btree_impl_with_order_dyn(                                                                 \
        &(scc_btree_impl_layout(type, order)){                                                     \
            .bt1 =                                                                                 \
                {                                                                                  \
                    .bt0 = {.bt_order = (order),                                                   \
        ...
        sizeof(scc_btree_impl_layout(type, order)), scc_btree_impl_curroff(type),                  \
        scc_btree_impl_rootoff(type, order))

#define scc_btree_new_dyn(type, compare)                                                           \
    (type *)scc_btree_impl_new_dyn(                                                                \
        &(scc_btree_impl_layout(type, SCC_BTREE_DEFAULT_ORDER)){                                   \
            .bt1 =                                                                                 \
                {                                                                                  \
                    .bt0 = {.bt_order = SCC_BTREE_DEFAULT_ORDER,                                   \
...
#define scc_btree_impl_base_qual(btree, qual)                                                      \
    scc_container_qual((unsigned char qual *)(btree) - scc_btree_impl_npad(btree),                 \
                       struct scc_btree_base, bt_fwoff, qual)

#define scc_btree_impl_base(btree) scc_btree_impl_base_qual(btree, )
...
#define scc_btree_clone(btree) scc_btree_impl_clone(btree, sizeof(*(btree)))
