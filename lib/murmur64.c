...
static inline void scc_murmur64_128_main_calc(uint64_t hs[static restrict 2u], uint64_t k1,
                                              uint64_t k2)
{
#define h1 hs[0u]
#define h2 hs[1u]
...
static inline void scc_murmur64_128_residual(uint64_t hs[static restrict 1u], void const *data,
                                             size_t size)
{
    ...
    switch (size & 15u) {
    case 15u:
        k2 ^= (uint64_t)p[14u] << 48u;
    case 14u:
        k2 ^= (uint64_t)p[13u] << 40u;
    case 13u:
        k2 ^= (uint64_t)p[12u] << 32u;
    case 12u:
        k2 ^= (uint64_t)p[11u] << 24u;
    case 11u:
        k2 ^= (uint64_t)p[10u] << 16u;
    case 10u:
        k2 ^= (uint64_t)p[9u] << 8u;
    case 9u:
        k2 ^= (uint64_t)p[8u];
        ...
        /* fallthrough */
    case 8u:
        k1 ^= (uint64_t)p[7u] << 56u;
    case 7u:
        k1 ^= (uint64_t)p[6u] << 48u;
    case 6u:
        k1 ^= (uint64_t)p[5u] << 40u;
    case 5u:
        k1 ^= (uint64_t)p[4u] << 32u;
    case 4u:
        k1 ^= (uint64_t)p[3u] << 24u;
    case 3u:
        k1 ^= (uint64_t)p[2u] << 16u;
    case 2u:
        k1 ^= (uint64_t)p[1u] << 8u;
    case 1u:
        k1 ^= (uint64_t)p[0u];
...
void scc_murmur64_128(struct scc_digest128 *digest, void const *data, size_t size,
                      uint_fast32_t seed)
{
