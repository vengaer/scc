...
add_custom_target (.config.init.cmake.stamp
    COMMAND ${Python_EXECUTABLE} ${SCCONFIG} ${CONFOPTS} -o ${CONFHDR} init
)

add_custom_target (.config.version.cmake.stamp
    COMMAND ${Python_EXECUTABLE} ${SCCONFIG} ${CONFOPTS} add SCC_VERSION_MAJOR ${SCC_VERSION_MAJOR} -C "Library major version"
    COMMAND ${Python_EXECUTABLE} ${SCCONFIG} ${CONFOPTS} add SCC_VERSION_MINOR ${SCC_VERSION_MINOR} -C "Library minor version"
    COMMAND ${Python_EXECUTABLE} ${SCCONFIG} ${CONFOPTS} add SCC_VERSION_PATCH ${SCC_VERSION_PATCH} -C "Library patch version"
